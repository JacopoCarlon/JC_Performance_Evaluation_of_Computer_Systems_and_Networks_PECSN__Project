...
void Job::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->tqi);
    doParsimPacking(b,this->tqosi);
    doParsimPacking(b,this->tso);
}

void Job::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->tqi);
    doParsimUnpacking(b,this->tqosi);
    doParsimUnpacking(b,this->tso);
}

omnetpp::simtime_t Job::getTqi() const
{
    return this->tqi;
}

void Job::setTqi(omnetpp::simtime_t tqi)
{
    this->tqi = tqi;
}

omnetpp::simtime_t Job::getTqosi() const
{
    return this->tqosi;
}

void Job::setTqosi(omnetpp::simtime_t tqosi)
{
    this->tqosi = tqosi;
}

omnetpp::simtime_t Job::getTso() const
{
    return this->tso;
}

void Job::setTso(omnetpp::simtime_t tso)
{
    this->tso = tso;
}
...
unsigned int JobDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_tqi
        FD_ISEDITABLE,    // FIELD_tqosi
        FD_ISEDITABLE,    // FIELD_tso
    };
...
int JobDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "tqi") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "tqosi") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "tso") == 0) return baseIndex + 2;
...
const char *JobDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "omnetpp::simtime_t",    // FIELD_tqi
        "omnetpp::simtime_t",    // FIELD_tqosi
        "omnetpp::simtime_t",    // FIELD_tso
    };
...
std::string JobDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_tqi: return simtime2string(pp->getTqi());
        case FIELD_tqosi: return simtime2string(pp->getTqosi());
        case FIELD_tso: return simtime2string(pp->getTso());
        default: return "";
    }
}
...
void JobDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_tqi: pp->setTqi(string2simtime(value)); break;
        case FIELD_tqosi: pp->setTqosi(string2simtime(value)); break;
        case FIELD_tso: pp->setTso(string2simtime(value)); break;
...
omnetpp::cValue JobDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_tqi: return pp->getTqi().dbl();
        case FIELD_tqosi: return pp->getTqosi().dbl();
        case FIELD_tso: return pp->getTso().dbl();
...
void JobDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_tqi: pp->setTqi(value.doubleValue()); break;
        case FIELD_tqosi: pp->setTqosi(value.doubleValue()); break;
        case FIELD_tso: pp->setTso(value.doubleValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Job'", field);
    }
}
